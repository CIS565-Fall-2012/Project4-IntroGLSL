(function() {
    ...
    (function initializeShader() {
        ...
        u_cxLocation = context.getUniformLocation(program,"u_cx");
        u_cyLocation = context.getUniformLocation(program,"u_cy");
    ...
    (function animate(){
        ...
        context.uniform1f(u_cxLocation, cx);
        context.uniform1f(u_cyLocation, cy);
